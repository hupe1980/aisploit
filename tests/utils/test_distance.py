...
@pytest.mark.parametrize("emb1, emb2, expected_distance", [
...
@pytest.mark.parametrize("emb1, emb2, expected_distance", [
    ...
    ([1.0, 2.0], [2.0, 4.0], 2.23606797749979),    # Parallel vectors with same direction
    ([1.0, 2.0], [-1.0, -2.0], 4.47213595499958),  # Parallel vectors with opposite direction
    ([1.0, 0.0], [1.0, 0.0], 0.0),                 # Identical vectors
])
